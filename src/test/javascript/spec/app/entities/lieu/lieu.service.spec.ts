...
describe('Service Tests', () => {
    describe('Lieu Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Lieu(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Lieu', async () => {
                const returnedFromService = Object.assign(
                    {
                        nom: 'BBBBBB'
                    },
