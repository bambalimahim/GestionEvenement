...
import dmn.sn.config.audit.AuditEventConverter;
import dmn.sn.domain.PersistentAuditEvent;
...
import static dmn.sn.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
